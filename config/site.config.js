...
module.exports = {
  ...
  userPrincipalName: process.env.USER_PRINCIPLE_NAME || 'mdpan@mdfansub.onmicrosoft.com',
  ...
  baseDirectory: process.env.BASE_DIRECTORY || '/mdpan',
  ...
  footer:
    'Powered by <a href="https://spcnwikia.top/" target="_blank" rel="noopener noreferrer">🥚</a>',
